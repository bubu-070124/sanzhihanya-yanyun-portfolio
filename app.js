...
const filterOrder = ['全部', '河西 · 方盘城废墟', '河西 · 湖泊', '无明春山', '江南', '青州地图', '黑夜天气', '耶律阿不里', '试炼 · 猫咪', '试炼 · 天禄', '试炼 · 望月', '试炼 · 郑愕', '试炼 · 萧翰', '试炼 · 赵大哥', '试炼 · 裴航二阶段', '试炼 · 河伯', '无界山 · 碧水云涛', '无界山 · 滹沱', '梦中不羡仙 · 竹林', '月湖暗道', '无相皇镇守', '弱水岸镇守', '开封 · 鬼市', '无相之地', '皇宫地图', '试炼 · 听梅', '凉州', '试炼 · 舞狮兄弟', '奇术特效 · 衍九矢', '奇术特效 · 自在无碍', '无界山 · 七色坪（黄花）'];
let activeKind = '全部';
let activePlace = '全部';
